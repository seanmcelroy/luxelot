...
public static class CryptoUtils
{
    ...
    public static AsymmetricCipherKeyPair GenerateKyberKeyPair()
    {
        ...
        KyberKeyGenerationParameters kyber_generation_parameters = new(new SecureRandom(), KyberParameters.kyber1024);
    ...
    {
        KyberKemGenerator kem_generator = new(new SecureRandom());
